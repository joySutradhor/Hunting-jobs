    ...
    return (
        <div className='md:mx-20'>
            <div className='shadow-sm p-2 my-3'>
                ...
                <p className='text-[#757575]'>Context API gives us super power , we can't need to props drilling . We use Context api for data passing grand father to grand child more easy way . The Context API is the React feature used for solving props drilling problems.</p>
            </div>
